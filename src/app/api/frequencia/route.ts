  ...
  try {
    ...
    try {
        ...
        if (!error && data) {
            ...
            // Aumentamos o cache para 12 horas para dados de anos anteriores, 
            // ou 6 horas para o ano atual
    ...
    // 2. SE NÃO TIVER NO BANCO OU EXPIROU -> FAZ O SCRAPING
    ...
    if (mainRes.ok) {
        ...
        // Dividimos o HTML pelas seções de presença
    ...
    // 3. PERSISTE NO BANCO DE DADOS (UPSERT)
    try {
        await supabase
            .from('frequencia_parlamentar')
